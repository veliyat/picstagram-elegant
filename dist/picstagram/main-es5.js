...
var routes = [
    { path: '', pathMatch: 'full', redirectTo: '/profile' },
    {
        ...
        loadChildren: function () { return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./components/picstagram/picstagram.module */ "./src/app/components/picstagram/picstagram.module.ts")).then(function (m) { return m.PicstagramModule; }); },
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.login(this.model)
            ...
            _this.messageService.setMsg({ msg: 'Invalid Credentials.', type: 'danger' });
        });
...
var PicstagramRoutingModule = /** @class */ (function () {
    function PicstagramRoutingModule() {
    }
    ...
    return PicstagramRoutingModule;
}());
...
var PicstagramComponent = /** @class */ (function () {
    function PicstagramComponent() {
    }
    PicstagramComponent.prototype.ngOnInit = function () {
    };
...
var PicstagramModule = /** @class */ (function () {
    function PicstagramModule() {
    }
...
var PostFormComponent = /** @class */ (function () {
    function PostFormComponent(postService, messageService, router) {
        this.postService = postService;
        this.messageService = messageService;
        this.router = router;
        this.caption = '';
    ...
    PostFormComponent.prototype.handleChange = function () {
        this.formDirty = true;
    };
    PostFormComponent.prototype.uploadImage = function (event) {
        var _this = this;
    ...
    PostFormComponent.prototype.addPost = function () {
        ...
        this.postService.addPost(data)
            .subscribe(function () {
            _this.messageService.setMsg({ msg: 'Post Added!', type: 'success' });
            _this.caption = '';
            _this.description = '';
            _this.imageUrl = '';
...
var PostItemComponent = /** @class */ (function () {
    function PostItemComponent(postService, messageService) {
        this.postService = postService;
        this.messageService = messageService;
        // console.log('Inside Constructor')
    }
    PostItemComponent.prototype.ngOnChanges = function (changes) {
    ...
    PostItemComponent.prototype.remove = function () {
        var _this = this;
        this.postService.removePost(this.post.id).subscribe(function (data) {
            _this.messageService.setMsg({ msg: 'Post Deleted!', type: 'success' });
        });
    };
...
var PostListComponent = /** @class */ (function () {
    function PostListComponent(postService, messageService) {
        this.postService = postService;
        this.messageService = messageService;
        this.posts = [];
    }
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(router, builder, authService, messageService) {
        this.router = router;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.authService.register(this.registerForm.value)
            .subscribe(function () {
            _this.messageService.setMsg({ msg: 'Registration Successful! Please Login', type: 'success' });
...
var passwordMatch = function (formGroup) {
...
var mustContainSymbol = function (control) {
...
var GlobalAlertComponent = /** @class */ (function () {
    function GlobalAlertComponent(messageService) {
        this.messageService = messageService;
        this.msg = '';
        this.type = '';
    }
    GlobalAlertComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.messageService.getMsg().subscribe(function (data) {
            _this.msg = data.msg;
            _this.type = data.type;
        });
    };
    GlobalAlertComponent.ctorParameters = function () { return [
...
var PostFormGuard = /** @class */ (function () {
    function PostFormGuard() {
    }
    PostFormGuard.prototype.canDeactivate = function (postForm) {
...
var JwtInterceptor = /** @class */ (function () {
    ...
    JwtInterceptor.prototype.intercept = function (req, next) {
        var user = this.authService.checkUser();
        if (user && user.token) {
            var reqWithHeaders = req.clone({
                setHeaders: {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (creds) {
        ...
        return this.http.post(this.loginUrl, creds)
            ...
            _this.subject.next(_this.checkUser());
            return data;
        }));
    };
    ...
    AuthService.prototype.getCurrentUserStatus = function () {
...
var MessageService = /** @class */ (function () {
    ...
    MessageService.prototype.setMsg = function (msg) {
        var _this = this;
        this.subject.next(msg);
        setTimeout(function () {
            _this.subject.next({ msg: '' });
        }, 3000);
    };
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getPosts = function () {
        return this.http.get(this.apiUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (posts) {
    ...
    PostService.prototype.uploadImage = function (image) {
    ...
    PostService.prototype.removePost = function (id) {
